...
//This is a investigation trying to recreate the geometry present on the Arcturians codes.

// window.onload = function() {

// 	document.body.onclick=function(e) {
// 			/*e가 존재하면 e변수를 event에 넣고,
// 			e가 undefine이면 window.event 속성을 변수 event에 넣는다. */
// 			var event=e || window.event;   
// 			document.body.innerHTML='';
// 			for(var key in event) {

// 					document.body.innerHTML += '<div>' + key + ' : ' + event[key] + '</div>';
// 			}
// 	};
// };
...
function draw() {
  ...
  for (circle of outterCircles) {
    ellipse(circle.x, circle.y, radius / 20, radius / 20);
  }
