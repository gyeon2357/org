 ...
 */
{
  ...
  class Grid {
    constructor(el) {
      ...
      this.DOM.closeCtrlBottom = document.querySelector(
        ".content__close__bottom"
      );
    ...
    initEvents() {
      ...
      this.DOM.closeCtrlBottom.addEventListener("click", () =>
        this.closeItem()
      );
    ...
    toggleContentElems(contentEl, delay, withAnimation, show = true) {
      ...
      TweenMax.to(
        [this.DOM.closeCtrlBottom, this.DOM.scrollIndicator],
        withAnimation ? 0.8 : 0,
        {
          ease: show ? Expo.easeOut : Expo.easeIn,
          delay: withAnimation ? delay : 0,
