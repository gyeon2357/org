(function (n) {
  var f = function (d) {
    ...
    v = function (d, f) {
      if (d) for (var e = d.length, h = 0; h < e; h++) f(h, d[h]);
    },
    x = function (d, f, e) {
    ...
    l = function (m, l) {
      var e = this,
        ...
        w = function (a, c, b, e) {
          ...
          c = h("cubeEffect")
            ? "rotateY(".concat(d, "deg)")
            : "translate3d(".concat(c, "px, 0, 0)");
          a &&
            (x(a.style, "TransitionTimingFunction", e),
            x(a.style, "TransitionDuration", "".concat(b, "ms")),
            x(a.style, "Transform", c));
        },
        y = function (a, c, b, e) {
          var d = 0,
            g = 0;
          if (a) {
            if (a.offsetParent) {
              do if (((d += a.offsetLeft), (g += a.offsetTop), a === e)) break;
      ...
      var G = function (a) {
        ...
        E = {
          ...
          template: {
            timelineItem: function (a) {
              return '\n<div class="story '
                .concat(!0 === d(a, "seen") ? "seen" : "", '">\n<a class="item-link" href="')
                .concat(d(a, "link"), '">\n<span class="item-preview">\n<img lazy="eager" src="')
                .concat(
                  h("avatars") || !d(a, "currentPreview") ? d(a, "photo") : d(a, "currentPreview"),
                  '" />\n</span>\n<span class="info" itemProp="author" itemScope itemType="http://schema.org/Person">\n<strong class="name" itemProp="name">'
                )
                .concat(d(a, "name"), '</strong>\n<span class="time">')
                .concat(
                  d(a, "lastUpdatedAgo"),
                  '</span>\n</span>\n</a>\n\n<ul class="items"></ul>\n</div>'
                );
            ...
            viewerItemPointer: function (a, c, b) {
              return '<span \nclass="'
                .concat(c === a ? "active" : "", " ")
                .concat(!0 === d(b, "seen") ? "seen" : "", '"\ndata-index="')
                .concat(a, '" data-item-id="')
                .concat(d(b, "id"), '">\n<b style="animation-duration:')
                .concat("" === d(b, "length") ? "3" : d(b, "length"), 's"></b>\n</span>');
            },
            viewerItemBody: function (a, c, b) {
              return '<div \nclass="item '
                .concat(!0 === d(b, "seen") ? "seen" : "", " ")
                .concat(c === a ? "active" : "", '"\ndata-time="')
                .concat(d(b, "time"), '" data-type="')
                .concat(d(b, "type"), '" data-index="')
                .concat(a, '" data-item-id="')
                .concat(d(b, "id"), '">\n')
                .concat(
                  "video" === d(b, "type")
                    ? '<video class="media" muted webkit-playsinline playsinline preload="auto" src="'
                        .concat(d(b, "src"), '" ')
                        .concat(d(b, "type"), '></video>\n<b class="tip muted">')
                        .concat(h("language", "unmute"), "</b>")
                ...
                .concat(
                  d(b, "link")
                    ? '<a class="tip link" href="'
                        .concat(d(b, "link"), '" rel="noopener" target="_blank">\n')
                        .concat(
                          d(b, "linkText") && "" !== d(b, "linkText")
                            ? d(b, "linkText")
                            : h("language", "visitLink"),
                          "\n</a>"
                        )
                    : "",
                  "\n</div>"
          ...
          var c = f("#zuck-modal-content"),
              ...
              setTimeout(function () {
                if ("" !== c && r[c] && "" !== d) {
                  ...
                  r.viewing &&
                    ...
                    r.viewing.classList.add(d),
                    r.viewing.classList.remove("viewing"));
                  r[c] &&
                    (r[c].classList.remove("stopped"),
                    r[c].classList.remove(c),
                    r[c].classList.add("viewing"));
                  (b = H(c)) && q(b, c);
                  ...
                  if ((b = f('#zuck-modal [data-story-id="'.concat(g, '"]')))) {
                    ...
                    b[0].innerHTML = '<b style="'.concat(A.style.cssText, '"></b>');
                  ...
                  w(p, "0", 0, null);
                  b &&
                    ((a = f('#zuck-modal .story-viewer[data-story-id="'.concat(a, '"]'))),
                    D(a, [b[0], b[1]], !0));
            ...
            q = function (a, b, c) {
              ...
              var A = "",
                ...
                l = d(a, "currentItem") || 0;
              if (f('#zuck-modal .story-viewer[data-story-id="'.concat(m, '"]'))) return !1;
              n.className = "slides";
              v(q, function (b, c) {
              ...
              u.className = "story-viewer muted "
                .concat(b, " ")
                .concat(c ? "" : "stopped", " ")
                .concat(h("backButton") ? "with-back-button" : "");
              u.setAttribute("data-story-id", m);
              u.querySelector(".slides-pointers .wrap").innerHTML = p;
              v(u.querySelectorAll(".close, .back"), function (a, b) {
              ...
              u.appendChild(n);
              "viewing" === b &&
                D(u, u.querySelectorAll('[data-index="'.concat(l, '"].active')), !1);
              ...
              var c = f("#zuck-modal"),
                ...
                l = function (b) {
                  ...
                  g &&
                    ...
                    !q && g && (b.preventDefault(), w(a, d + p.x, 0, null)));
                },
                t = function I(A) {
                  ...
                  if (p) {
                    ...
                    var t = 0 > p.x,
                      v = t
                        ? f("#zuck-modal .story-viewer.next")
                        : f("#zuck-modal .story-viewer.previous");
                  ...
                  r && clearInterval(r);
                  k &&
                    (D(k, k.querySelectorAll(".active"), !1),
                  ...
                  if (m)
                    if (
                      ...
                      (m = !1),
                      (k = function () {
                        u.x > n.screen.width / 3 || !h("previousTap")
                          ? e.navigateItem("next", A)
                          : e.navigateItem("previous", A);
                      }),
                      (t = f("#zuck-modal .viewing")) && B)
                    )
                      t.classList.contains("muted") ? N(B, t) : k();
                    else return k(), !1;
                };
          ...
          return {
            show: function (a, b) {
              ...
              h("callbacks", "onOpen")(a, function () {
                ...
                h("openEffect")
                  ? ((b = f("#".concat(k, ' [data-id="').concat(a, '"] .item-preview'))),
                    (g = y(b)),
                    (d.style.marginLeft = "".concat(g[0] + b.offsetWidth / 2, "px")),
                    (d.style.marginTop = "".concat(g[1] + b.offsetHeight / 2, "px")),
                    (d.style.display = "block"),
                    (d.slideWidth = f("#zuck-modal .story-viewer").offsetWidth),
                    setTimeout(function () {
            ...
            next: function (a) {
              h("callbacks", "onEnd")(e.internalData.currentStory, function () {
                ...
                c &&
                  ...
                  (e.data[a].seen = !0),
                  (e.internalData.seenItems[a] = !0),
                  O("seenItems", e.internalData.seenItems),
                  K());
            ...
            close: function () {
              ...
              h("callbacks", "onClose")(e.internalData.currentStory, function () {
                ...
                h("openEffect")
                  ...
                  : ((c.innerHTML = ""), (a.style.display = "none"));
              });
            },
          };
        })(),
        C = function (a, c) {
          ...
          if (!h("reactive") || c)
            v(d, function (a, b) {
              ...
              (e.data[b].items = f),
              (b = h("callbacks", "onDataUpdate")) && b(e.data, function () {});
        },
        P = function (a, c) {
          var b = a.getAttribute("data-id"),
            d = !1;
          ...
          try {
            e.data[b] || (e.data[b] = {}),
              (e.data[b].id = b),
              (e.data[b].photo = a.getAttribute("data-photo")),
              (e.data[b].name = a.querySelector(".name").innerText),
              (e.data[b].link = a.querySelector(".item-link").getAttribute("href")),
              (e.data[b].lastUpdated = a.getAttribute("data-last-updated")),
              (e.data[b].seen = d),
              e.data[b].items || ((e.data[b].items = []), (e.data[b].noItems = !0));
          } catch (p) {
            e.data[b] = { items: [] };
          }
        ...
        H = function (a) {
          ...
          return c && (c = f("#".concat(k, ' [data-id="').concat(c, '"]'))[a])
            ? ((c = c.getAttribute("data-id")), e.data[c] || !1)
            : !1;
        },
        K = function () {
        ...
        D = function (a, c, b) {
          ...
          if ("video" === d.getAttribute("data-type")) {
            ...
            d = function () {
              g.duration &&
                x(
                  f.getElementsByTagName("b")[0].style,
                  "AnimationDuration",
                  "".concat(g.duration, "s")
                );
            };
        ...
        Q = function (a) {
          return h("localStorage")
            ? ((a = "zuck-".concat(k, "-").concat(a)),
              n.localStorage[a] ? JSON.parse(n.localStorage[a]) : !1)
            : !1;
        };
      e.data = h("stories") || {};
      e.internalData = {};
      ...
      e.add = e.update = function (a, c) {
        ...
        q
          ...
          : ((g = document.createElement("div")),
            (g.innerHTML = h("template", "timelineItem")(a)),
            (g = g.firstElementChild));
        !1 === a.seen &&
          ((e.internalData.seenItems[b] = !1), O("seenItems", e.internalData.seenItems));
      ...
      e.navigateItem = e.nextItem = function (a, c) {
        ...
        var m = k.querySelectorAll('[data-index="'.concat(d, '"]')),
          ...
          r = w[1];
        k && y && r
          ? ((d = (d = h("callbacks", "onNavigateItem"))
              ? h("callbacks", "onNavigateItem")
              : h("callbacks", "onNextItem")),
            d(b, r.getAttribute("data-story-id"), function () {
              "previous" === a
                ? (l.classList.remove("seen"), n.classList.remove("seen"))
                : (l.classList.add("seen"), n.classList.add("seen"));
      ...
      return (function () {
        m &&
          m.querySelector(".story") &&
          v(m.querySelectorAll(".story"), function (a, c) {
            P(c);
          });
        h("backNative") &&
        ...
        m.className += " stories "
          .concat(a, " ")
          .concat(c, " ")
          .concat("".concat(h("skin")).toLowerCase());
        return e;
      })();
    };
  l.buildTimelineItem = function (d, f, e, h, n, w) {
    var m = { id: d, photo: f, name: e, link: h, lastUpdated: n, items: [] };
    v(w, function (d, e) {
  ...
  "undefined" !== typeof exports
    ? ("undefined" !== typeof module && module.exports && (exports = module.exports = l),
      (exports.ZuckJS = l))
    : (n.ZuckitaDaGalera = n.Zuck = l);
  return l;
})(window);
