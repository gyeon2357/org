    ...
    return (
      ...
      (e._unbind = function () {
        o.hasWheelEvent &&
          ...
          o.hasMouseWheelEvent &&
            r(this, l)[l].removeEventListener("mousewheel", this._onMouseWheel),
          o.hasTouch &&
            (r(this, l)[l].removeEventListener(
              "touchstart",
              this._onTouchStart
            ),
            r(this, l)[l].removeEventListener("touchmove", this._onTouchMove)),
          o.hasPointer &&
            o.hasTouchWin &&
      ...
      ((a = e.call(this) || this).onWindowResize = function () {
        ...
        (a.onVirtualScroll = function (t) {
          ...
          if (
            ...
            n.ctrlKey ||
              i ||
              ((a.smooth = n.changedTouches ? a.smoothTouch : a.options.smooth),
              a.stopped
                ? n.preventDefault()
                : a.smooth &&
                  4 !== n.buttons &&
 ...
 */ var d,
  ...
  ze = function (t) {
    for (var e, r, n, i, o = 0, s = ""; ~(e = t.indexOf("random(", o)); )
      (n = t.indexOf(")", e)),
        ...
        (s +=
          t.substr(o, e - o) + De(i ? r : +r[0], i ? 0 : +r[1], +r[2] || 1e-5)),
        (o = n + 1);
  ...
  je = function (t, e, r) {
    ...
    if (!i) for (s = (i = t.split(Ue)).length - 1; c < s; c++) a += i[c] + l[c];
    return a + i[s];
  },
  Ue = (function () {
    var t,
  ...
  ir = function (t, e, r, n) {
    ...
    return (
      Ft(t, function (t) {
        for (var e in ((Qe[t] = vt[t] = o), (Qe[(i = t.toLowerCase())] = r), o))
          Qe[
    ...
    return (
      ...
      (e.totalTime = function (t, e) {
        ...
        if (r && r.smoothChildTiming && this._ts) {
          for (ue(this, t), !r._dp || r.parent || ce(r, this); r && r.parent; )
            r.parent._time !==
              r._start +
                (r._ts >= 0
                  ? r._tTime / r._ts
...
var cr = (function (t) {
  ...
  return (
    ...
    (r.render = function (t, e, r) {
      ...
      if (
        (this !== v && w > _ && t >= 0 && (w = _), w !== this._tTime || r || b)
      ) {
        if (
          (m !== this._time &&
            y &&
    ...
    if (
      ...
      if (
        ...
        R &&
          ...
          r < 0 && E && T && !C ? R.render(-1, !0) : R.revert(E && D ? Mt : St),
          (R._lazy = 0)),
        x)
      ) {
        if (
  ...
  Hr = {
    ...
    registerEffect: function (t) {
      ...
      (n || "").split(",").forEach(function (t) {
        return (
          t && !Pt[t] && !vt[t] && bt(e + " effect requires " + t + " plugin.")
        );
      }),
        (Ct[e] = function (t, e, n) {
...
var Kr,
  ...
  Yn = function (t) {
    ...
    return (
      (e && (e.width || e.height)) || t.getBBox === zn || (e = zn.call(t, !0)),
      !e || e.width || e.x || e.y
        ? e
        : {
            x: +Ln(t, ["x", "cx", "x1"]) || 0,
...
var fi,
  ...
  gi = {
    ...
    init: function (t, e, r, n, i) {
      ...
      (this.tween = r),
      e))
        if ("autoRound" !== h && ((s = e[h]), !Pt[h] || !gr(h, e, r, n, t, i)))
          if (
            ((u = typeof s),
            (c = Vn[h]),
 ...
 */ var _i,
  ...
  Gi = function (t, e) {
    ...
    var i = zi.indexOf(t),
      o = n === Vi.sc ? 1 : 2;
    !~i && (i = zi.push(t) - 1), zi[i + o] || t.addEventListener("scroll", Hi);
    var s = zi[i + o],
      a =
        s ||
        (zi[i + o] =
        ...
        (Z.enable = function (t) {
          return (
            Z.isEnabled ||
              ...
              ((n.indexOf("touch") >= 0 && Si) || n.indexOf("pointer") >= 0) &&
                (qi(i, Ai[0], gt, a, X),
                qi(ot, Ai[2], mt),
                qi(ot, Ai[3], mt),
                q && qi(i, "click", ut, !1, !0),
...
var ro,
  ...
  Go = function (t) {
    return (
      ...
      (Ko(t)
        ? function () {
            return (sa.width = io.innerWidth), (sa.height = io.innerHeight), sa;
          }
        : function () {
            return bs(t);
          })
  ...
  Zs = function (t, e) {
    if (!qo || t) {
      ...
      xo && ha.sort(),
        e || Vs(),
        zi.forEach(function (t) {
          Jo(t) && (t.smooth && (t.target.style.scrollBehavior = "auto"), t(0));
        }),
  ...
  ha = (function () {
    ...
    return (
      (t.prototype.init = function (e, r) {
        if (
          ((this.progress = this.start = 0), this.vars && this.kill(!0, !0), Bo)
        ) {
          var n,
            i,
            o,
          ...
          if (
            ...
            st &&
              ...
              (o = Jo(st.snapTo)
                ...
                : !1 !== st.directional
                ? function (t, e) {
                    return Ss(st.snapTo)(t, Fo() - kt < 500 ? 0 : e.direction);
                  }
          ...
          (xt.previous = function () {
                ...
                if (J && i && qo) Os(t, "scrollEnd", Ws);
                  ...
                  if (
                    ...
                    (d = ys(J)),
                      ...
                      L &&
                        (L.value
                          ? (L.style["overflow" + ft.a.toUpperCase()] = L.value)
                  ...
                  z &&
                    ...
                    xt.revert(!1, !0),
                    Y &&
                      ((Ot = -1), xt.isActive && Et(l + g * N), Y.restart(!0)),
                    (go = 0),
                    r &&
                      pt &&
                      (r._initted || X) &&
            ...
            (xt.getTrailing = function (t) {
              var e = Ls.indexOf(xt),
                r =
                  xt.direction > 0 ? Ls.slice(0, e).reverse() : Ls.slice(e + 1);
              return (
                $o(t)
                  ? r.filter(function (e) {
                    ...
                    pt ||
                      (!R || go || No
                        ...
                        : (R._dp._time - R._start !== R._time &&
                          ...
                          R.resetTo
                            ? R.resetTo("totalProgress", P, r._tTime / r._tDur)
        ...
        var n = t.getBoundingClientRect(),
          ...
          o =
            null == e
              ...
              ? (parseFloat(e) * i) / 100
              : parseFloat(e) || 0;
        return r ? (n.left + o) / io.innerWidth : (n.top + o) / io.innerHeight;
      }),
